...
import katakanaL from './KatakanaLetters';
...
class katakanaPractice extends Component {
    constructor() {
        super();
        this.ansButton = [];
    ...
    getRandomGana() {
        ...
        // shuffling the hiragana to practice on
         this.ganaQ = shuffle(katakanaL)[0]
        ...
        controllAnswer(answer) {
            if (answer === this.state.ganaCorrect) {
                this.setState({ answerStatus: 'Correct answer', getNewQ: true, bgColor: 'green'})
            } else {
        ...
        return (
            <div className="katakana-content">
               ...
               <h3>Practice Katakana</h3>
               <p>Guess the katakana : </p>
